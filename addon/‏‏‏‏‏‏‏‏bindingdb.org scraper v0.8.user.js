...
$( ".content_index p" ).append('<table  id="tableofscraption" style="width:100%"><tbody class="multisort"><tr id="Human" id="MAINxSELECT"><th colspan="1">Target/Host</th><th colspan="1">species</th><th colspan="1">Ki nM</th><th colspan="1">IC50 nM</th><th colspan="1">kd nM</th><th colspan="1">EC50 nM</th><th colspan="1">act as</th></tr></tbody></table><style>#tableofscraption {margin-top: 3px;} table {  font-family: arial, sans-serif;  border-collapse: collapse;  width: 100%;}td, th {  border: 1px solid #dddddd; text-align: center;  padding: 0px;}tr:nth-child(even) {  background-color: #dddddd;}table * {    font-size: 9px;} #clickMe {font-size: 10px; padding: 0px 2px; cursor: pointer;}</style>');
