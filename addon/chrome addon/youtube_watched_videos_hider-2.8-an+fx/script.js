...
if (parseInt(progressfullvl) >= `${item.confperc.value}`) {$(this).parent().parent().parent().parent().parent().parent().parent().hide();}
})
...
$( "#overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= `${item.confperc.value}`) {$(this).parent().parent().parent().parent().parent().parent().hide();}
})
...
$( "#overlays.ytd-thumbnail #progress" ).each(function (index) {
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= `${item.confperc.value}`) {$(this).parent().parent().parent().parent().parent().parent().parent().parent().hide();}
})	
...
var progressfullvl = $(this).attr('style').replace('width: ','').replace('%;',''); 
if (parseInt(progressfullvl) >= `${item.confperc.value}`) {$(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().hide();}
})
